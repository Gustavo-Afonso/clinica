...
export default function HeroSection() {
  return (
    <section id="inicio" className="relative bg-sky-950 text-white py-20 lg:py-32">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <h1 className="text-4xl lg:text-6xl font-bold leading-tight">
                Cuidando da sua <span className="text-yellow-600">saúde</span> com excelência
              </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" className="bg-yellow-600 hover:bg-amber-700 text-white">
                Agendar Consulta
